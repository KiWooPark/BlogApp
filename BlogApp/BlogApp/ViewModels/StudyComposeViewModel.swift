...
//    func fetchFinishDate(day: Int?) -> (currentDate: Date?, nextWeekDate: Date?) {
//        let finishDate = Date().calculateFinishDate(deadlineDay: day ?? 0)
//
//        currentDate = finishDate.currentDate
//        nextWeekDate = finishDate.nextWeekFinishDate
//
//        print("fetchFinishDate", currentDate, nextWeekDate)
//
